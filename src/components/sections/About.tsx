  ...
  return (
    <section id="about" className="py-20 bg-muted/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium mb-4 glass-effect">
            About Me
          </span>
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 bg-gradient-to-r from-primary via-blue-500 to-pink-500 bg-clip-text text-transparent">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed glass-card p-6">
              <p>
                  ...
                  <Card className="glass-card border-none shadow-lg overflow-hidden">
                    <CardContent className="p-4 text-center relative">
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="text-2xl font-bold bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">{stat.value}</div>
